...
[fig1,mdl,ds] = calcswitch(exp_name,BEHdata,rescale,dostats,doplots,wincrit); %apply rescaling of rewards
csvwrite(strcat('staybehavior_',exp_name,'.csv'),double(ds))
